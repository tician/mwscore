...
void BioloidController::setup(uint8_t servo_count)
{
	if (servo_count < 1)
		numServos_ = 20;
	else
	...
	// Allocate storage
	id_ = (uint8_t*) malloc(numServos_ * sizeof(uint8_t));
	pose_ = (bc_pose_t*) malloc(numServos_ * sizeof(bc_pose_t));
	nextpose_ = (bc_pose_t*) malloc(numServos_ * sizeof(bc_pose_t));
	deltas_ = (int16_t*) malloc(numServos_ * sizeof(int16_t));
	offsets_ = (int16_t*) malloc(numServos_ * sizeof(int16_t));
	resolutions_ = (uint8_t*) malloc(numServos_ * sizeof(uint8_t));
